...
const envSchema = z.object({
  ...
  AUTH_COOKIE_NAME: z.string().default("barbearia_staff_session"),
  AUTH_COOKIE_CLIENTE: z.string().default("barbearia_cliente_session"),
...
export const env = envSchema.parse({
  ...
  AUTH_COOKIE_CLIENTE: process.env.AUTH_COOKIE_CLIENTE,
